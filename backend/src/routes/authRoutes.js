...
// Função para configurar o Socket.IO no router
module.exports = function (io) {
  ...
  router.post("/login", async (req, res) => {
    ...
    try {
      ...
      // Exemplo de envio de evento via Socket.IO ao realizar login
  ...
  router.delete("/delete/:id", async (req, res) => {
    ...
    try {
      ...
      // Exemplo de envio de evento via Socket.IO ao deletar usuário
  ...
  router.patch("/update-role/:id", async (req, res) => {
    ...
    try {
      ...
      // Exemplo de envio de evento via Socket.IO ao atualizar papel do usuário
      io.emit("roleUpdated", { userId: id, newRole: role });
