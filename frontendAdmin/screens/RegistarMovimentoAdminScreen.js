...
const RegistarMovimentoAdminScreen = () => {
  ...
  useEffect(() => {
    ...
    else setSelectedIng(ingredienteParam);
  }, []);
...
const styles = StyleSheet.create({
  ...
  submitBtn: { padding: hp("2%"), borderRadius: wp("2%"), alignItems: "center", marginTop: hp("1%") },
...
export default RegistarMovimentoAdminScreen;
