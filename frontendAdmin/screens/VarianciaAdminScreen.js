            ...
            <View style={[styles.varianciaPctRow, { backgroundColor: COLORS.primary }]}>
              <View
                style={[
                  ...
                  { width: `${Math.min(100, item.variancia_percentagem)}%`, backgroundColor: sc.color },
                ]}
              />
...
const styles = StyleSheet.create({
  ...
  emptyContainer: { paddingTop: hp("10%"), alignItems: "center", gap: hp("1%"), paddingHorizontal: wp("8%") },
  emptyText: { fontSize: wp("4.5%"), fontWeight: "600", textAlign: "center", opacity: 0.6 },
});

export default VarianciaAdminScreen;
